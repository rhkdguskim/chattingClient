export enum PAGE_PATHS {
  ...
  export const KAKAO_REDIRECT_URL = process.env.REACT_APP_OAUTH_REDIRECT_URL || 'http://localhost:3001/oauth';

  export const NAVER_REST_API_KEY = 'oTcoSe0Nvv4q6RaZyyAS';
  export const NAVER_REDIRECT_URL = process.env.REACT_APP_OAUTH_REDIRECT_URL || 'http://localhost:3001/oauth';

  export const GOOGLE_REST_API_KEY = '846841962221-phpmlehpgrv1lj4ko9fkrmnalt3uo1fk.apps.googleusercontent.com';
  export const GOOGLE_REDIRECT_URL = process.env.REACT_APP_OAUTH_REDIRECT_URL || 'http://localhost:3001/oauth';
